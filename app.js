...
function renderModal() {
    ...
    if (type === "fixture") {
        ...
        const linkedHtml = `<div class="form-group fixture-link-picker"><label class="form-label">Linked Matches</label><input class="form-input" id="a-linked-fixture-query" placeholder="Search by opponent or date" value="" oninput="handleFixtureLinkInput()" onfocus="showFixtureLinkSuggestions(this.value)" onkeydown="handleFixtureLinkKeydown(event)"><input type="hidden" id="a-linked-fixture-id" value=""><div class="autocomplete-dropdown" id="a-linked-fixture-dropdown"></div><div class="fixture-link-current" id="a-linked-fixture-current"></div></div>`;
